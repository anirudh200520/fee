...
export const post_job = async (formData) => {
    ...
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/postAJob`, {
            method: 'POST',
            headers: {
...
export const get_job = async (page = 1, limit = 20) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getAllJobs?page=${page}&limit=${limit}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${Cookies.get('token')}`
            }
...
export const get_specified_job = async (id) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getSpecifiedJob?id=${id}`, {
            method: 'GET',
...
export const apply_job = async (formData) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/applyJob`, {
            method: 'POST',
            headers : {'Authorization': `Bearer ${Cookies.get('token')}`},
            body: formData,
        });
...
export const get_my_applied_job = async (id) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getAppliedJobs?id=${id}`, {
            method: 'GET',
            headers : {'Authorization': `Bearer ${Cookies.get('token')}`}
        })
        const data = res.json();
...
export const get_my_posted_job = async (id) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getPostedJobs?id=${id}`, {
            method: 'GET',
            headers : {'Authorization': `Bearer ${Cookies.get('token')}`}
        })
        const data = res.json();
...
export const get_all_applications = async (id) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getAllApplicationsOfSpecifiedJob?id=${id}`, {
            method: 'GET',
            headers : {'Authorization': `Bearer ${Cookies.get('token')}`}
        })
        const data = res.json();
...
export const change_application_status = async (formData) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/responseOfApplication`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${Cookies.get('token')}`
...
export const get_application_details = async (id) => {
    try {
        const res = await fetch(`${API_BASE_URL}/api/job/getApplicationDetail?id=${id}`, {
            method: 'GET',
            headers : {'Authorization': `Bearer ${Cookies.get('token')}`}
        })
        const data = res.json();
